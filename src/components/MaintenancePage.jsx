...
import { Construction, Clock, Wrench, Users, Grip, ArrowRight } from 'lucide-react';
import Header from './Header';
import Footer from './Footer';

const MaintenancePage = ({ pageName = 'this section', message }) => {
    const defaultMessage = `We're currently upgrading our ${pageName} to serve you better!`;
        ...
        <div className="font-sans text-gray-800 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex flex-col">
            ...
            <main className="flex-grow w-full flex items-center justify-center px-4 py-16">
                <div className="max-w-2xl w-full text-center">
                    ...
                    <div className="mb-8 relative animate-bounce inline-block">
                        ...
                        {/* Rotating Wrench */}
                        <div
                            className="absolute -bottom-2 -right-2 bg-white p-3 rounded-full shadow-lg animate-spin"
