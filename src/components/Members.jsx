...
const Members = () => {
    ...
    const members = [
        ...
        },
        {
            ...
            type: "Learner" // Correction based on image provided earlier, keeps consistency or updates if needed.
            // Actually the user provided image showed "Teacher" for Jimmy in the first request, 
            // but let's stick to what we have or update if this request implies changes. 
            // The new request is just to ADD Gig workers. I will keep existing as is.
        },
        {
            id: 4,
